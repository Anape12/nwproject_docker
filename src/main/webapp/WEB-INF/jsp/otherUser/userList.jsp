...
<% UserEntity loginUser = (UserEntity) session.getAttribute("loginUser"); List<UserEntity>
    userList = (List<UserEntity
        >) request.getAttribute("userList"); String errorMsg = (String) request.getAttribute("errorMsg"); String
        userInfo = loginUser.getUserId(); String successMsg = (String) request.getAttribute("successMsg"); userInfo =
        userInfo + ":" +loginUser.getPassword(); %>
        <!DOCTYPE html>
        ...
        <html>
            ...
            <body>
                ...
                <form method="post" action="${pageContext.request.contextPath}/UserView" name="form1">
                    ...
                    <button
                        class="search-btn3"
                        style="margin-left:570px; margin-top:30px"
                        type="submit"
                        name="action"
                        value="change"
