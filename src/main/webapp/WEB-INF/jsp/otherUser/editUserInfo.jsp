...
<% UserEntity loginUser = (UserEntity) session.getAttribute("loginUser"); List<UserEntity>
    userList = (List<UserEntity
        >) request.getAttribute("userList"); String errorMsg = (String) request.getAttribute("errorMsg");
        List<PermissionMasterEntity>
            permissionList = (List<PermissionMasterEntity
                >) request.getAttribute("permissionLevels"); %>
                <!DOCTYPE html>
                <html>
                    <head>
                        <meta charset="UTF-8" />
                            ...
                            >
                                ...
                                <div class="edit-card">
                                    <div class="form-row">
                                        ...
                                        <input type="text" name="nowID" value="<%=userinfo.getUserId()%>" readonly />
                                    </div>

                                    <div class="form-row">
                                        <label>変更後ユーザーID</label>
                                        <input type="text" name="editID" value="<%=userinfo.getUserId()%>" />
                                    </div>

                                    <div class="form-row">
                                        <label>変更後パスワード</label>
                                        <input type="password" name="editPassword" placeholder="変更後パスワード" />
                                    </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <select name="editPermission">
                                            ...
                                            <option
                                                ...
                                                data-selected="<%= permission.getPermissionId().equals(userinfo.getPermission()) %>"
                                            >
                                ...
                                <p class="password-note">※ パスワードは半角英数字で入力してください</p>

                                <div class="button-area">
                                    <button class="login-btn">更新する</button>
                                    <button class="delete-btn" type="button">削除（工事中）</button>

                                    <button class="close-btn" type="button" onclick="window.close();">閉じる</button>
                                </div>
                            </form>
                        </div>
                        <script src="${pageContext.request.contextPath}/js/jsp-boolean-attributes.js"></script>
                    </body>
                </html> </PermissionMasterEntity></PermissionMasterEntity></UserEntity
></UserEntity>
