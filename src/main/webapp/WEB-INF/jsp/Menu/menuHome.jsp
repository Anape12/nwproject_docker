...
<main class="workspace-home">
  ...
  <form class="home-logout" action="${pageContext.request.contextPath}/Logout" method="get"><button><i class="fa-solid fa-right-from-bracket"></i> ログアウト</button></form>
