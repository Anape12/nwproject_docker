...
<form action="${pageContext.request.contextPath}/WorkManagement" method="get" target="_blank"><button class="menu-btn" type="submit"><i class="fa-solid fa-business-time"></i><span>勤怠表入力</span></button></form>
