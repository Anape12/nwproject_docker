<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="jp.nw.model.MyCalendar" %>
...
<html lang="ja">
    ...
    <body>
        ...
        <div id="container">
            ...
            <a class="new-thread-link" href="${pageContext.request.contextPath}/ThreadCreate"> ＋ 新規スレッド </a>
